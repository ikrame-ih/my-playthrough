...
Best read in the browser: **`abrir-en-navegador/plan_pruebas.html`** (tables, print/PDF). This file is the Markdown source.

---

## Scope

What was tested, how, and the outcome. Covers **manual** UI/API checks and **Vitest** unit tests on pure helpers. Not a full code review.
...
Cases V-01 to V-04 below match logic in `server/utils/normalize.js`.
